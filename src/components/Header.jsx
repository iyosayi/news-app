...
const Header = () => {
  return (
    <nav className="bg-[#1a014e] h-10 w-full py-2 fixed mb-5 z-50">
      <div className="h-full text-white flex items-center gap-6 max-w-[1248px] m-auto">
        <svg
        ...
        <div
          role="button"
          className="border flex items-center gap-2 py-1 px-2 text-xs ml-auto"
        >
          <p>Live TV</p>
          <div className="bg-[#e21d2c] w-[6px] h-[6px] rounded-full" />
        </div>
        <GiHamburgerMenu role="button" className="text-2xl mr-6" />
      </div>
    </nav>
  );
};
